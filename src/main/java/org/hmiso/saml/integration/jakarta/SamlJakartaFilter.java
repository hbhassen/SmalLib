package org.hmiso.saml.integration.jakarta;
...
public class SamlJakartaFilter implements Filter {
    ...
    public static final String CONFIG_KEY = "smalsamlLib.saml.config";
    public static final String HELPER_KEY = "smalsamlLib.saml.helper";
